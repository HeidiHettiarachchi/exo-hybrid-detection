...
# # --- Adaptive annular detection with sharpness + symmetry filters ---
# def detect_candidates(snr_map, xc, yc, pixscale=1.0,
#                       snr_threshold=5.0, min_sep_pix=55,
#                       circle_radius=30, edge_crop=25):
...
#         # Sharpness test — real point sources fall off in both axes
#         r = 5
...
#         # Symmetry test — real sources are symmetric, text/edges are not
...
#     # Cluster — one detection per distinct spatial peak
