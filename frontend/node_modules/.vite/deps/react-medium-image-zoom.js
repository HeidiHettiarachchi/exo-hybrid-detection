...
var ControlledBase = class extends import_react.default.Component {
  ...
  render() {
    ...
    if (hasImage) {
      ...
      modalContent = ZoomContent ? import_react.default.createElement(ZoomContent, { buttonUnzoom: modalBtnUnzoom, modalState, img: modalImg, isZoomImgLoaded, onUnzoom: handleUnzoom }) : import_react.default.createElement(
...
function Uncontrolled({ onZoomChange, ...props }) {
  ...
  const handleZoomChange = import_react.default.useCallback((value, { event }) => {
    setIsZoomed(value);
    onZoomChange?.(value, { event });
  }, [onZoomChange]);
  return import_react.default.createElement(Controlled, { ...props, isZoomed, onZoomChange: handleZoomChange });
}
export {
  Controlled,
